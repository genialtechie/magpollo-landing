  ...
  return (
    <>
      <div className="px-5 md:w-9/12 mx-auto h-fit">
        {success && (
          <div className="fixed overscroll-contain overflow-y-hidden inset-0 bg-white flex flex-col justify-center items-center z-50 p-5">
            <div className="w-3/4 h-fit flex flex-col justify-center relative">
              <Link
                href="/"
                className="absolute right-5 top-3 hover:underline hover:text-red "
              >
                Go back home
              </Link>
              <div className="clear-right"></div>
              <h1 className="text-red text-5xl font-mono uppercase mb-4">
                All Set!
              </h1>
              <p className="font-sans mb-5">
                Your project details have been successfully submitted!
              </p>
              <h2 className="text-3xl font-mono uppercase mb-4">
                What&apos;s Next?
              </h2>
              <div className="font-sans mb-5">
                <ul className="list-disc list-inside">
                  <li>
                    Our team will review the information you provided and start
                    crafting a tailored approach for your project.
                  </li>
                  <li>
                    You will soon receive a follow-up email with an outline of
                    the next steps, including scheduling a kick-off meeting.
                  </li>
                  <li>
                    During the meeting, we&apos;ll dive deeper into your project
                    needs and expectations, ensuring every detail is aligned
                    with your vision.
                  </li>
                </ul>
              </div>
