  ...
  return (
    <div className="bg-white w-full h-full">
      <div className="py-20 lg:px-20 px-5">
        ...
        <div className="relative w-full h-fit group mx-auto flex items-center">
          <svg
            width="1337"
            height="286"
            ...
            className="fill-red hidden md:block scale-x-90 mx-auto relative inset-x-0"
          >
            <path
          ...
          <div className="md:absolute m-auto inset-0 md:w-2/3 w-fit p-10 h-fit font-sans font-bold tracking-wide rounded-md bg-red md:bg-transparent text-white text-xl xl:text-2xl text-center before:content-quote before:block before:mb-1 lg:before:mb-7">
            I love every project I work on to be organised and the guys at
            Magpollo get it right.
            <br />
            <div className="text-white/70 font-sans tracking-normal font-normal mt-4 lg:mt-7">
              - Tameika Staton
            </div>
          </div>
        </div>
