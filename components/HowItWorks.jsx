...
const HowItWorks = () => {
  return (
    <div className="bg-white w-full h-full">
      <div className="py-20 lg:px-10 px-5">
        ...
        <div className="relative w-11/12 h-fit group mx-auto">
          <svg
            width="1337"
            height="286"
            ...
            className="fill-red hidden lg:block"
          >
            <path
          ...
          <div className="lg:absolute m-auto inset-0 lg:w-2/3 w-fit p-10 h-fit font-mono rounded-md bg-red lg:bg-transparent text-white text-2xl text-center before:content-quote before:block before:mb-7">
            I love every project I work on to be organised and the guys at
            Magpollo get it right.
            <br />
            <div className="text-white/70 font-sans mt-7">- John Doe</div>
          </div>
        </div>
      </div>
    </div>
